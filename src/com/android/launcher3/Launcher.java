...
public class Launcher extends BaseActivity
    ...
    public void startEdit(final ItemInfo info, final ComponentName component, final Rect sourceBounds, final Bundle opts) {
        ...
        final IconPackArrayAdapter adapter = new IconPackArrayAdapter(this,
                iconPacks.first);
        final ListPopupWindow listPopupWindow = new ListPopupWindow(new ContextThemeWrapper(this, R.style.AlertDialogCustom));
    ...
    private class RotationPrefChangeHandler implements OnSharedPreferenceChangeListener {
        ...
        public void onSharedPreferenceChanged(
            ...
            if (Utilities.KEY_DESKTOP_LABELS_FONT.equals(key)) {
                needRestart();
            }
            if (Utilities.KEY_DRAWER_LABELS_FONT.equals(key)) {
                needRestart();
            }
            if (Utilities.KEY_FOLDER_LABELS_FONT.equals(key)) {
                needRestart();
            }
            if (Utilities.KEY_SMARTSPACE_FONT.equals(key)) {
                needRestart();
            }
        }
    }
